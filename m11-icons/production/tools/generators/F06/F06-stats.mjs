...
const IDS=('spin src-tauri sso stack stencil store story stylus sublime syntax target taskfile tasks telegram television toc tools trash travis trigger trunk ui unity update upload vagrant verdaccio vitepress vm vs vscode-test vue-directives vuepress vuex-store wakatime wasp windows windsurf wit wordpress www zeabur zed').split(' ');
